...
def launch_gui():
    ...
    tk.Button(frame, text="Browse File", command=browse_file).pack(pady=5)
    tk.Button(frame, text="Browse Folder", command=browse_folder).pack(pady=5)
